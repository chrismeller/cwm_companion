...
add_action( 'after_setup_theme', 'chrismkii_setup' );
...
function chrismkii_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Navigation', 'chrismkii' ),
	) );
	...
	define( 'HEADER_IMAGE_WIDTH', apply_filters( 'chrismkii_header_image_width', 950 ) );
	define( 'HEADER_IMAGE_HEIGHT', apply_filters( 'chrismkii_header_image_height', 140 ) );
 ...
 * @since Twenty Ten 1.0
 */
function chrismkii_admin_header_style() {
?>
<style type="text/css">
#headimg {
